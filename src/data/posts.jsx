const postsList = [
    ...
    {
        title: "Simply Explained Alphas",
        excerpt: "A summarized guide about Alphas, for all the players. ",
        url: "https://forums.pokemmo.com/index.php?/topic/150680-simply-explained-alphas-and-alpha-hordes-generalities/",
        category: 'guide',
        credits: 'Biqueta'
    },
    {
        title: "All regions in PokeMMO complete walkthrough ",
        excerpt: "This guide will help you know what to do during the story and where you can find all the items and hidden items. ",
...
export const Posts = postsList.reverse()