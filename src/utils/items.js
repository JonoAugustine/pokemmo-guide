...
export const getCosmeticSetupImage = (cosmetics) => {
    ...
    for (const key in InterfaceItems.sceneCosmeticParam) {
        if (Object.hasOwnProperty.call(InterfaceItems.sceneCosmeticParam, key)) {
            ...
            scenes.push({
                name: scene,
                url: `https://cdn-a.pokemmo.net/dress-room/v1/${key}/2/1/${selectedClothes[6]}/${selectedClothes[12]}/${selectedClothes[4]}/${selectedClothes[5]}/${selectedClothes[8]}/${selectedClothes[3]}/${selectedClothes[2]}/${selectedClothes[10]}/${selectedClothes[9]}/${selectedClothes[7]}.png`
            })
        }
    }
    return scenes;
